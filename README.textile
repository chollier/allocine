...
Bug reports : http://github.com/Florian95/allocine/issues

Mis a disposition sous licence MIT. (c) 2008 Jordan Bracco <jordan@lifeisdead.net>
Mise a jour par Florian Lamache pour être compatible avec la nouvelle version du site de Allocine.
...
<pre>
  ...
  => [["136668", "Plan 9 from Outer Space"], ["13031", "Plan 9 from Outer Space"]]
</pre>
...
<pre>
  ...
  => {"182"=>"X-Files : Aux frontières du réel", "223"=>"Lost"}
</pre>
...
<pre>
  ...
  => "américain"
  >> movie.image
  => "http://images.allocine.fr/r_160_214/b_1_cfd7e1/medias/nmedia/18/71/65/84/19141370.jpg"
  >> movie.duree
  => 1h19
  >> movie.trailer
  => ""
...
@trailer@ est le numéro de la vidéo chez Allocine. Pour avoir le Flash de la bande annonce, ce numéro est a concaténer avec : http://www.allocine.fr/blogvision/_Trailer ID_

h4. Série

@En cours de modification, les regex actuelles ne remontent que le titre.@
